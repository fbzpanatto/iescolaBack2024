    ...
    findAllWhere(options, request, transaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const teacherClasses = yield this.teacherClassrooms(request === null || request === void 0 ? void 0 : request.body.user, transaction);
                const isAdminSupervisor = teacher.person.category.id === personCategories_1.pc.ADMN || teacher.person.category.id === personCategories_1.pc.SUPE;
                let result = yield transaction.getRepository(Classroom_1.Classroom)
                    .createQueryBuilder("classroom")
                    .select("classroom.id", "id")
                    .addSelect("classroom.shortName", "name")
                    .addSelect("school.shortName", "school")
