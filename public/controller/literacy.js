...
class LiteracyController extends genericController_1.GenericController {
                    ...
                    for (let level of literacyLevels) {
                        ...
                        for (let st of studentClassrooms) {
                            for (let el of st.literacies) {
                                if (((_a = el.literacyLevel) === null || _a === void 0 ? void 0 : _a.id) &&
    ...
    getStudentClassroomsWithLiteracy(classroom, userBody, teacherClasses, yearName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lastYear = yield data_source_1.AppDataSource.getRepository(Year_1.Year).findOne({
            ...
            if (!lastYear || Number(classroomNumber) === 1) {
                const result = studentClassrooms.map((studentClassroom) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    return Object.assign(Object.assign({}, studentClassroom), { literacyFirsts: {
                            id: literacyFirsts === null || literacyFirsts === void 0 ? void 0 : literacyFirsts.id,
                            literacyLevel: (_a = literacyFirsts === null || literacyFirsts === void 0 ? void 0 : literacyFirsts.literacyLevel) !== null && _a !== void 0 ? _a : {
                                id: "NA",
                                name: "NA",
                                shortName: "NA",
                            },
            ...
            const result = studentClassrooms.map((studentClassroom) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!(lastLiteracy === null || lastLiteracy === void 0 ? void 0 : lastLiteracy.literacyLevel)) {
                    ...
                    return Object.assign(Object.assign({}, studentClassroom), { literacyFirsts: {
                            id: literacyFirsts === null || literacyFirsts === void 0 ? void 0 : literacyFirsts.id,
                            literacyLevel: (_b = literacyFirsts === null || literacyFirsts === void 0 ? void 0 : literacyFirsts.literacyLevel) !== null && _b !== void 0 ? _b : {
                                id: "NA",
                                name: "NA",
                                shortName: "NA",
                            },
                ...
                return Object.assign(Object.assign({}, studentClassroom), { literacyFirsts: {
                        id: lastLiteracy === null || lastLiteracy === void 0 ? void 0 : lastLiteracy.id,
                        literacyLevel: (_c = lastLiteracy === null || lastLiteracy === void 0 ? void 0 : lastLiteracy.literacyLevel) !== null && _c !== void 0 ? _c : {
                            id: "NA",
                            name: "NA",
                            shortName: "NA",
                        },
                ...
                for (let classroom of arrayOfClassrooms) {
                    ...
                    for (let tier of literacyTiers) {
                        ...
                        for (let level of literacyLevels) {
                            ...
                            localTier === null || localTier === void 0 ? void 0 : localTier.levels.push({
                                id: level.id,
                                name: level.name,
                                total: totalPerLevel,
                                rate: 0,
