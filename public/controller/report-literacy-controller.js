...
exports.literacyReportController = void 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield data_source_1.AppDataSource.transaction((CONN) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const allSchools = yield CONN.getRepository(School_1.School)
                        ...
                        .getMany();
                    const filteredData = yield CONN.getRepository(School_1.School)
                        .createQueryBuilder("school")
                        .leftJoinAndSelect("school.classrooms", "classroom")
                        .leftJoinAndSelect("classroom.studentClassrooms", "studentClassrooms")
                        .leftJoinAndSelect("studentClassrooms.year", "year")
                    ...
                    for (let school of finalArray) {
                        let localSchool = { id: school.id, name: school.name, tiers: [] };
...
exports.literacyReportController = new ReportLiteracy();
