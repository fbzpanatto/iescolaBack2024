...
class TextGenderGradeReportController extends genericController_1.GenericController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield data_source_1.AppDataSource.transaction((CONN) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const examLevel = yield this.getExamLevel(CONN);
                    const examTier = yield this.getexamTier(CONN);
                    const textGender = yield this.getTextGender(textGenderId, CONN);
                    if (!year)
                        return { status: 404, message: 'Ano não encontrado.' };
                    const allData = yield this.getAllData(classroomNumber, textGender, year, CONN);
                    const filteredSchool = yield this.filteredSchool(classroomNumber, textGender, year, search, CONN);
                    ...
                    for (let row of finalArray) {
                        let localSchool = { id: row.id, name: row.name, exams: [] };
    ...
    getTextGender(textGenderId, CONN) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield CONN.getRepository(TextGender_1.TextGender)
    ...
    getExamLevel(CONN) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield CONN.getRepository(TextGenderExam_1.TextGenderExam)
    ...
    getexamTier(CONN) { return CONN.getRepository(TextGenderExamTier_1.TextGenderExamTier).createQueryBuilder('textGenderExamTier').getMany(); }
    createCityHall() {
        return {
            id: 'ITA',
            name: 'PREFEITURA DO MUNICIPIO DE ITATIBA',
    ...
    buildSchoolQuery(CONN, classroomNumber, textGender, year) {
        return __awaiter(this, void 0, void 0, function* () {
            return CONN.getRepository(School_1.School)
    ...
    getAllData(classroomNumber, textGender, year, CONN) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.buildSchoolQuery(CONN, classroomNumber, textGender, year)).orderBy('school.name', 'ASC').getMany();
        });
    }
    filteredSchool(classroomNumber, textGender, year, search, CONN) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = yield this.buildSchoolQuery(CONN, classroomNumber, textGender, year);
            if (search) {
