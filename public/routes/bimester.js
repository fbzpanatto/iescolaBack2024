...
exports.BimesterRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () { const response = yield bimester_1.bimesterController.findOneById(req.params.id, req); return res.status(response.status).json(response); }));
...
exports.BimesterRouter.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () { const response = yield bimester_1.bimesterController.updateId(req.params.id, req.body); return res.status(response.status).json(response); }));
