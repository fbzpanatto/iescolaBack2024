...
exports.ClassroomRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () { const response = yield classroom_1.classroomController.findOneById(req.params.id, req); return res.status(response.status).json(response); }));
...
exports.ClassroomRouter.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () { const response = yield classroom_1.classroomController.updateId(req.params.id, req.body); return res.status(response.status).json(response); }));
