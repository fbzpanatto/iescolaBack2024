...
exports.DisciplineRouter.put('/:id', validators_1.ID_PARAM, (req, res) => __awaiter(void 0, void 0, void 0, function* () { var _a; const response = yield discipline_1.discController.updateId((_a = req.params) === null || _a === void 0 ? void 0 : _a.id, req.body); return res.status(response.status).json(response); }));
