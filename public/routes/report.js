...
exports.ReportRouter.get('/:year', havePermission_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () { const data = yield report_1.reportController.reportFindAll(req); return res.status(data.status).json(data); }));
