...
const UPDATE_VALIDATORS = [validators_1.ID_PARAM, validators_1.VALIDATE_TEACHER, validators_1.BODY_VALIDATION_TEACHER];
exports.TeacherRouter = (0, express_1.Router)();
exports.TeacherRouter.get('/pending-transfer', havePermission_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield teacher_1.teacherController.getRequestedStudentTransfers(req);
    return res.status(response.status).json(response);
}));
exports.TeacherRouter.get('/form', havePermission_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield teacher_1.teacherController.teacherForm(req);
    return res.status(response.status).json(response);
}));
