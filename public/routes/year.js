...
exports.YearRouter.get('/:id', validators_1.ID_PARAM, havePermission_1.default, (req, res) => {
...
exports.YearRouter.delete('/:id', validators_1.ID_PARAM, havePermission_1.default, (req, res) => {
