...
const UPDATE_VALIDATORS = [validators_1.VALIDATE_ID, validators_1.VALIDATE_YEAR, validators_1.BODY_VALIDATION_YEAR];
...
exports.YearRouter.get('/:id', validators_1.VALIDATE_ID, havePermission_1.default, (req, res) => {
...
exports.YearRouter.delete('/:id', validators_1.VALIDATE_ID, havePermission_1.default, (req, res) => {
