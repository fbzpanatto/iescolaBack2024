  ...
  async getReport(request: Request) {
    ...
    try {
      ...
      const allSchools = await AppDataSource.getRepository(School)
        ...
        .andWhere("classroom.shortName LIKE :classroom", {
          classroom: `%${classroom}%`,
        })
      ...
      const cityHall = {
        ...
        studentsClassrooms: allSchools.flatMap((school) =>
          school.classrooms.flatMap((classroom) => classroom.studentClassrooms),
        ),
      };
      ...
      const filteredSchoolArray = filteredData.map((school) => ({
        ...
        studentsClassrooms: school.classrooms.flatMap(
          (classroom) => classroom.studentClassrooms,
        ),
      }));
      ...
      return {
        ...
        data: {
          literacyTiers,
          literacyLevels,
          schools: [...filteredSchoolArray, cityHall],
