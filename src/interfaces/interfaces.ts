...
export interface TestBodySave { bimester: { id: number }, category: { id: number }, classroom: { id: number }[], discipline: { id: number }, name: string, testQuestions?: { id: number, order: number, answer: string, questionGroup: { id: number, name: string }, active: boolean, question: { id: number, title: string, images: number, person: { id: number }, discipline: { id: number, name: string }, classroomCategory: { id: number, name: string }, skill: { id: number, reference: string, description: string } } }[], year: { id: number }, user: UserInterface }
...
export interface UpdateStudentAnswers { user: { user: number, ra: string, category: number, iat: number, exp: number }, testId: number, studentId: number | string, questions: { studentQuestionId: number, answer: string, testQuestionId: number, studentId: number, rClassroomId: number | null }[]}