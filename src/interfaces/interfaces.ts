...
export interface TrainingAndSchedulesBody { id?: number, name: string, category: number, discipline?: number, disciplineName?: string, classroom: number, trainingSchedules: { id: number | null, trainingId: number | null, dateTime: string }[], observation?: string, user: UserInterface }
