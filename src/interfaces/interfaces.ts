...
export interface BodyTextGenderExamGrade { studentClassroom: { id: number }, textGender: { id: number }, textGenderExam: { id: number }, textGenderExamTier: { id: number }, textGenderExamTierLevel: { id: number }, user: UserInterface }
