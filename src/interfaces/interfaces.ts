...
export interface qTestQuestions { test_question_id: number, test_question_order: number, test_question_answer: string, test_question_active: boolean, question_id: number, question_title?: string, question_group_id: number, question_group_name: string, skill_id?: number, skill_reference?: string, skill_description?: string }
...
export interface TeacherParam { id: number, name: string, disciplineId?: number | null, discipline: string, contract?: number | null, classroom?: number | string, schoolId: number, shortName: string, trainingTeachers?: { id: number, teacherId: number, trainingId: number, statusId: number | string }[] }