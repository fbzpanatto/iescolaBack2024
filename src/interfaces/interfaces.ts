...
export interface qTestToken { id: number, code: string, createdAt: string, expiresAt: string, test: string, bimester: string, discipline: string, teacher: string, classroom: string, school: string }