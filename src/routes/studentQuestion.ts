...
import { VALIDATE_ID, VALIDATE_STUDENT_QUESTIONSTATUS, BODY_VALIDATION_STUDENT_QUESTION, VALIDATE_STUDENT_QUESTIONANSWER, BODY_VALIDATION_STUDENT_ANSWER} from "../middleware/validators";
import havePermission from "../middleware/havePermission";

const UPDATE_VALIDATORS_ANSWER = [VALIDATE_ID, VALIDATE_STUDENT_QUESTIONANSWER, BODY_VALIDATION_STUDENT_ANSWER]
const UPDATE_VALIDATORS_STATUS = [VALIDATE_ID, VALIDATE_STUDENT_QUESTIONSTATUS, BODY_VALIDATION_STUDENT_QUESTION]
