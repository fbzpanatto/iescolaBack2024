...
import {
  BODY_STUDENT_TEST_QUESTIONS,
  STUDENT_CLASSROOM_ID_REF,
  VALIDATE_STUDENT_TEST_QUESTIONS,
  YEAR_NAME_PARAM
...
StudentTestRouter.get("/test/:id", [YEAR_NAME_PARAM, STUDENT_CLASSROOM_ID_REF], havePermission, async (req: Request, res: any) => {
